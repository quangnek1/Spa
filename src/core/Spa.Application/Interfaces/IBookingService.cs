...
public interface IBookingService
{
	...
	// 3.1 Lấy danh sách đơn hàng theo trang (Dành cho Admin, có thể dùng chung API này cho cả Web và WebAdmin, chỉ khác về filter điều kiện)
	Task<PagedResult<BookingResponseDto>?> GetAllBookingPagingAsync(BookingPagingRequest request);
