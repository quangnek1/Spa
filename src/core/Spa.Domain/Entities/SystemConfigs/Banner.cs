...
public class Banner : EntityAuditBase<int>
{
    ...
    [Column(TypeName = "nvarchar(250)")] public string ImageUrl { get; set; } = default!; // Link ảnh

    [Column(TypeName = "nvarchar(250)")] public string? Link { get; set; } // Bấm vào ảnh thì dẫn đi đâu
